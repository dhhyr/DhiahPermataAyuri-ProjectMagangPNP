                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                              Uang Masuk Bulan Ini</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Rp.50.365.000</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Jumlah Beras Terjual </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">250 Kilogram</div>
                                        </div>
                                        <div class="col-auto">
